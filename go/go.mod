module github.com/chronowave/client/go

go 1.19

require (
	github.com/apache/arrow/go/v10 v10.0.0
	github.com/chronowave/codec v0.1.0
	github.com/chronowave/fbs/go v0.1.0
...
require (
	...
	github.com/chronowave/ssql/go v0.1.0 // indirect
